...
class PersonaRepository extends ServiceEntityRepository
{
    ...
    public function findPersona(string $nombreApellidos, string $cargo, string $entidad){
        return $this->createQueryBuilder('p')
            ->where('p.nombresApellidos = :nombreApellidos AND p.cargo = :cargo AND p.entidad = :entidad')
